...
class TestShibSettingView:
    ...
    def test_index_acl(self,client,users,user_index,is_can):
        with patch("weko_accounts.admin.ShibSettingView.render",return_value=make_response()):
    ...
    def test_index(self,client,users):
        ...
        with patch("weko_accounts.admin.ShibSettingView.render",return_value=make_response()) as mock_render:
